...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="bg-aqua"><a href="#tab_1-1" data-toggle="tab" aria-expanded="false">Proyectos</a></li>
              <li class="bg-yellow"><a href="#tab_2-2" data-toggle="tab" aria-expanded="false">Estado</a></li>
